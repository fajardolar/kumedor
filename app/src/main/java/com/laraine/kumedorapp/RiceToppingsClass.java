 ...
 */
public class RiceToppingsClass extends Activity {
...
//                if (position == 0) {
    ...
    public void getFromSdcard() {
        File file = new File(android.os.Environment.getExternalStorageDirectory(), "Kumedor/Rice Toppings");
...
//            try {
//                Bitmap myBitmap = BitmapFactory.decodeFile(mResources.get(position));
//                Log.i("Rs", mResources.get(position));
